...
// Update the interface to accept transactionCount and period
    ...
    >
      <div className="p-4">
        <div className="flex items-center justify-between mb-3">
          ...
          <span className="text-xs text-zinc-600 dark:text-zinc-400">{period}</span>
        </div>
...
// Helper function to map string icon names to actual components
